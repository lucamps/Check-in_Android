...
public final class BancoDadosSingleton {
    ...
    private final String[] SCRIPT_DATABASE_CREATE = new String[] {
            ...
            "INSERT INTO Checkin (Local, qtdVisitas, cat, latitude, longitude) VALUES " +
                    "('Libertas Cachaçaria',54,1,-20.4251,-42.24514)," +
                    "('Bar do Leão',4,1,-20.42214,-42.45714)," +
                    "('Universidade Federal de Viçosa',800,3,-20.4251,-42.24514);"
